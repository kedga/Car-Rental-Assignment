...
public class BookingProcessor : BaseService
{
    ...
    public void CreateNewBooking (IVehicle vehicle)
    {
        ...
        {
            if (associatedPerson.SocialSecurityNumber != "")
            {
                ...
                _dataManagement.Bookings.FirstOrDefault(booking => booking.Id == vehicle.LastBookingId)!.BookingStatus = BookingStatuses.Open;
    ...
    public void ReturnVehicle (IVehicle vehicle)
    {
        ...
        {
            _dataManagement.errorMessage = "Please enter distance driven.";
            return;
        }
        ...
        booking.Vehicle.BookingStatus = BookingStatuses.Available;
        CalculateTotalCost();
